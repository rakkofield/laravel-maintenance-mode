...
class MaintenanceModeManager extends Manager
{
     ...
     *
     * @return \RakkoInc\LaravelMaintenanceMode\Foundation\FileBasedMaintenanceMode
     */
     ...
     *
     * @return \RakkoInc\LaravelMaintenanceMode\Foundation\CacheBasedMaintenanceMode
     *
    ...
    protected function createCacheDriver(): CacheBasedMaintenanceMode
    {
        return new CacheBasedMaintenanceMode(
            ...
            'rakko-inc:maintenance-mode:down'
        );
    }
